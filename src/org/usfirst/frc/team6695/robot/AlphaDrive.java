 ...
 * driving.
 */
public class AlphaDrive implements MotorSafety {
	...
	/**
	 * Constructor for AlphaDrive with 2 motors specified with channel numbers.
	 * Set up parameters for a two wheel drive system where the left and right
	 * motor pwm channels are specified in the call. This call assumes Talons
	 * for controlling the motors.
	 *
	 * @param leftMotorChannel
	 *            The PWM channel number that drives the left motor.
	 * @param rightMotorChannel
	 *            The PWM channel number that drives the right motor.
	 */
	public AlphaDrive(final int leftMotorChannel, final int rightMotorChannel) {
	...
	/**
	 * Constructor for AlphaDrive with 4 motors specified with channel numbers.
	...
	/**
	 * Constructor for AlphaDrive with 2 motors specified as SpeedController
	 * objects. The SpeedController version of the constructor enables programs
	 * to use the AlphaDrive classes with subclasses of the SpeedController
	 * objects, for example, versions with ramping or reshaping of the curve to
	 * suit motor bias or dead-band elimination.
	 *
	 * @param leftMotor
	 *            The left SpeedController object used to drive the robot.
	 * @param rightMotor
	 *            the right SpeedController object used to drive the robot.
	 */
	public AlphaDrive(SpeedController leftMotor, SpeedController rightMotor) {
	...
	/**
	 * Constructor for AlphaDrive with 4 motors specified as SpeedController
	 * objects. Speed controller input version of AlphaDrive (see previous
	 * comments).
	 *
	 * @param rearLeftMotor
	 ...
	 *            robot.
	 */
	public AlphaDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor, SpeedController frontRightMotor,
	 ...
	 *            will be selected for rotation rate.
	 */
	public void arcadeDrive(GenericHID stick, double throttle) {
		arcadeDrive(stick, true, throttle);
	}
	...
	public void arcadeDrive(GenericHID moveStick, final int moveAxis, GenericHID rotateStick, final int rotateAxis,
			boolean squaredInputs, double throttle) {
		double moveValue = moveStick.getRawAxis(moveAxis);
		double rotateValue = rotateStick.getRawAxis(rotateAxis);

		arcadeDrive(moveValue, rotateValue, squaredInputs, throttle);
	}
	...
	public void arcadeDrive(GenericHID moveStick, final int moveAxis, GenericHID rotateStick, final int rotateAxis,
			double throttle) {
		arcadeDrive(moveStick, moveAxis, rotateStick, rotateAxis, true, throttle);
	}
	 ...
	 *            The value to use for the rotate right/left
	 */
	public void arcadeDrive(double moveValue, double rotateValue,  double throttle) {
		arcadeDrive(moveValue, rotateValue, true, throttle);
	}
	...
	/**
	 * Configure the scaling factor for using AlphaDrive with motor controllers
